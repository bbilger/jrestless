...
Since this framework is just a wrapper around Jersey we can use the features provided by JAX-RS like filters but also Jersey's custom extensions like support for Spring - not Spring MVC, though since this functionality is provided by JAX-RS itself.
