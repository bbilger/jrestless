...
public class GatewayContainerRequestTest {

	@Test
	public void testGetters() throws IOException {
		GatewayContainerRequest request = new GatewayContainerRequest(URI.create("/123"), URI.create("/456"), "DELETE",
	...
	private Constructor<GatewayContainerRequest> getConstructor() {
		try {
			return GatewayContainerRequest.class.getConstructor(URI.class, URI.class, String.class, InputStream.class, Map.class);
