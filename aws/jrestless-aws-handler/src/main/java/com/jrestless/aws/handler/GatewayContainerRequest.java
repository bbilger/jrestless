 ...
 *
 */
public class GatewayContainerRequest implements JRestlessContainerRequest {
	...
	public GatewayContainerRequest(@Nonnull URI baseUri, @Nonnull URI requestUri, @Nonnull String httpMethod,
	...
	public boolean equals(final Object other) {
		...
		GatewayContainerRequest castOther = (GatewayContainerRequest) other;
	...
	public String toString() {
		return "GatewayContainerRequest [baseUri=" + baseUri + ", requestUri=" + requestUri + ", httpMethod="
